                ...
                <section className="text-gray-600 body-font">
                    <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                        ...
                        <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 lg:w-2/6 rounded-lg md:w-1/2 md:ml-auto md:mt-0 ">
                            ...
                            <input type="email" id="email" name="email" required onChange={handleUserInput} placeholder='John@example.com' className="w-full px-3 py-1 text-base mt-2 leading-8 text-gray-700  transition-colors duration-200 ease-in-out border border-gray-300 rounded outline-none  focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none" />
                            </div>
    
                        
                            <div className="relative mb-4">
                                <label htmlFor="password" className="text-sm text-gray-600 leading-7">Password<span className='text-red-500'>*</span></label>
                            <input type="password" id="password" name="password" required onChange={handleUserInput}   placeholder='Enter your password' className="w-full px-3 py-1 text-base mt-2 leading-8 text-gray-700  transition-colors duration-200 ease-in-out border border-gray-300 rounded outline-none  focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none" />
                            </div>
    
                            <button  type='submit' onClick={handleFormSubmit} className='w-full px-8 text-lg py-2 border-0 rounded focus:outline-none   text-white font-bold bg-yellow-500  hover:bg-yellow-600'>Login</button>
