            ...
            <section 
                className="flex flex-col-reverse items-center justify-center py-5 md:flex-row md:gap-7 bg-gradient-to-r from-amber-50 to-orange-300 ">
                    <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
                        <div className="flex justify-center md:justify-normal items-center text-4xl font-extrabold tracking-tight">
                        <h1 className="pb-5 text-transparent bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text">
                            Enjoy the slice
                        </h1>
                        <span className="ml-2 text-black text-4xl animate-bounce">😋</span>
                        </div>
                        ...
                        <button onClick={()=>navigate('/menu')} className="flex items-center px-4 py-2 text-white bg-yellow-500 rounded-md hover:bg-yellow-600 hover:scale-105 transition-transform shadow-md hover:shadow-lg">
                            Order now
                    ...
                    <div className="ml-20 relative">
                        <img
                        src={leaf}
                        className="absolute top-[-40px] left-[40%] w-8 h-8 rounded-2xl animate-leaf-shower opacity-60 blur-[0.3px] rotate-[15deg] pointer-events-none"
                        alt="leaf"
                        />
                        <img
                        src={leaf2}
                        className="absolute bottom-[-60px] left-[55%] w-6 h-6 animate-leaf-shower opacity-40 blur-sm rotate-[25deg] pointer-events-none rounded-2xl"
                        style={{ animationDelay: '1.5s' }}
                        alt="leaf"
                        />
                        <img
                        src={leaf2}
                        className="absolute top-[-50px] left-[70%] w-6 h-6 rounded-xl animate-leaf-shower opacity-50 blur-[0.2px] rotate-[-10deg] pointer-events-none"
                        style={{ animationDelay: '2.8s' }}
                        alt="leaf"
                        />
                        <img
                        src={leaf3}
                        className="absolute top-[-50px] right-[70%] w-6 h-6 rounded-2xl animate-leaf-shower opacity-50 blur-[0.2px] rotate-[-10deg] pointer-events-none"
                        style={{ animationDelay: '2.8s' }}
                        alt="leaf"
                        />
                        <img
